...
. Open GraphQL Playground URL printed in the terminal.
...
In this guide we are going to explore the capabilities of datasync by using
a sample application available as part of {data-sync-starter}.
