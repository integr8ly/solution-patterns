...
. Using the *Manage Credentials* form:
.. In the *Password* field, enter the password `customer-password`.
...
.. Click *Set Password*.
. You will see a *Set password* confirmation modal.
. Click the *Set password* button to confirm your changes.
