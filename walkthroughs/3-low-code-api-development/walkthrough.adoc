...
Greeting response
----
.. For the *Response Type*, click *Choose Type* and then select *String*.
.. You will then see an additional drop-down displayed, with the *Type* now showing "*String* as *String*".
