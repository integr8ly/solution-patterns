...
+
NOTE: If using a cluster that has self signed certs you will not be able to use the URL option below. You will need to copy the url into a browsers and create a .json file with contets and use the *Upload OpenAPI Document* instead.
