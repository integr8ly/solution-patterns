...
+
NOTE: If using a cluster that has self signed certs you will not be able to use the URL option below. You will need to copy the contents
below and create a .json file and use the *Upload OpenAPI Document* instead.
